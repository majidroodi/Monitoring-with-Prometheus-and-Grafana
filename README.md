...
In the world of IT and Cloud Computing, Observability is the ability to understand the internal state of a system based on the data it produces — such as logs, metrics, and traces.
...
Whitebox Monitoring: Observing internal metrics of the system, such as CPU, memory, logs, and application-level metrics. The system’s internal state is exposed for monitoring.
...
Saturation: How “full” or busy the service is (CPU, memory, disk, queue length).
